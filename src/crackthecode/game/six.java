...
public class six extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text5=(TextView)findViewById(R.id.timer5);
		countDownTimer = new MyCountDownTimer(startTime, interval);
		//text5.setBackgroundColor(Color.YELLOW);
		
		Typeface font6 = Typeface.createFromAsset(getAssets(), "Courneuf-Regular.ttf");
		text5.setTextColor(Color.YELLOW);		
	    text5.setTypeface(font6);
		
		 text5.setText(text5.getText() + String.valueOf(startTime / 1000));
	...
	b6.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			if(e5.getText().toString().equals("quit"))
			 {countDownTimer.cancel();
			   timerHasStarted = false;
				Intent next14= new Intent(six.this , MainActivity.class);
				 startActivity(next14);
			 }
			else{
			if(e5.getText().toString().equals(""))
			 {
				 			 e5.setError("CAN'T LEFT EMPTY");
			 }
			else{
			if(e5.getText().toString().equals("sun"))
			 {
				 countDownTimer.cancel();
				   timerHasStarted = false;
				 Toast.makeText(getApplicationContext(), "CORRECT ANSWER", 1000).show();
				 Intent next= new Intent(six.this , seven.class);
				 startActivity(next);
			 }
			 else
			 {countDownTimer.cancel();
			   timerHasStarted = false;
				 ...
				 Intent s  =new Intent(six.this , MainActivity.class);
				 startActivity(s);
			 }
	...
	public class MyCountDownTimer extends CountDownTimer {
		  ...
		  public void onFinish() {
		   text5.setText("Time's up!");
		   Toast.makeText(getApplicationContext(), "YOU HAVE TAKEN TOO LONGER !!!", 1000).show();
		 
		   Intent back= new Intent(six.this , MainActivity.class);
		   startActivity(back);
		  }

		  @Override
		  public void onTick(long millisUntilFinished) {
		   text5.setText("" + millisUntilFinished / 1000);
		  }
		 }
